...
- **Local-first LLM routing.** Default roles: `embed=nomic-embed-text`, `light_gen=qwen3.6`, `contextual_blurb=gemma4:31b`, `extraction=gemma4:31b`, `agentic=qwen3.6`. Cloud is a config-only fallback. No cloud key required to run. (Spec §7.)
